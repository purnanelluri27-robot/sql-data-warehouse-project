...
script purpose:
The stored procedure performs ETL(extract,transform,load) to populate 'silver' schema tables from 'bronze' table.
 ...
 DECLARE @start_time DATETIME, @end_time DATETIME, @batch_start_time DATETIME, @batch_end_time DATETIME;
  BEGIN TRY
   ...
   CASE WHEN UPPER(TRIM(gen)) IN ('F', 'FEMALE') THEN 'Female'
        ...
        ELSE 'N/A'
   END AS gen --narmalize gender values and handle unknown cases
   ...
   CASE WHEN TRIM(cntry) = 'DE' THEN 'Germany'
        WHEN TRIM(cntry) IN ('US','USA') THEN 'United Staes'
